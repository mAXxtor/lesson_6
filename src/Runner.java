...
/**
 * Created by maxxt on 26.04.2016.
 */
public class Runner {
    ...
    private void addTestClients() {
        ...
        clinic.addClient(2, new Client("Nastya", new Cat("Sharik")));
        clinic.addClient(3, new Client("Ivan", new Dog("Sharik")));
    }
    ...
    private void addNewClientAction() {
        System.out.println("Input the client's name:");
    ...
    private Pet requestNewPet() {
        ...
        System.out.println("Input the pet's name:");
